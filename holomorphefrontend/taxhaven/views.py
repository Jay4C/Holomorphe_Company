...
tax_haven_topic = "taxhaven/tax_haven_topic.html"


def index(request):
    return render(request, "taxhaven/index.html")


def corporation_tax(request):
    context = {
        "data": [
    ...
    return render(request, tax_haven_topic, context)
...
def carry_forward_of_ordinary_tax_losses(request):
    context = {
        "data": [
...
def carry_back_of_ordinary_tax_losses(request):
    context = {
        "data": [
            {comparison: bahamas, value: n_a_the_bahamas_does_not_levy_corporation_tax, color: table_danger},
...
def capital_gains_tax_rate(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0%", color: table_success},
...
def vat_registration_threshhold(request):
    context = {
        "data": [
...
def vat_filing_and_payment(request):
    context = {
        "data": [
...
def tax_return_requirement(request):
    context = {
        "data": [
            {comparison: bahamas, value: "No", color: table_success},
...
def tax_return_due_date(request):
    context = {
        "data": [
...
def tax_residency_requirements(request):
    context = {
        "data": [
            {comparison: bahamas, value: n_a_the_bahamas_does_not_levy_corporation_tax, color: table_success},
...
def tax_rate_on_dividends_from_local_investments(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0%", color: table_success},
            {comparison: barbados, value: "0%", color: table_success},
...
def tax_rate_on_dividends_from_foreign_investments(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0%", color: table_success},
...
def withholding_tax_on_dividend_payments_to_foreign_shareholders(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0%", color: table_success},
...
def tax_rate_on_interest_income(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0%", color: table_success},
...
def withholding_tax_on_interest_payments_to_foreign_recipients(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0%", color: table_success},
...
def tax_deductibility_of_interest_expense(request):
    context = {
        "data": [
            {comparison: bahamas, value: n_a_the_bahamas_does_not_levy_corporation_tax, color: table_danger},
...
def tax_rate_on_royalty_income(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0%", color: table_success},
            {comparison: barbados, value: "Normal corporation tax rates apply", color: table_success},
...
def withholding_tax_on_royalty_payments_to_foreign_recipients(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0%", color: table_success},
            {comparison: barbados, value: "0% for IBCs and ISRLs.  ; - 15% in all other cases.", color: table_danger},
...
def tax_deductibility_of_royalty_expense(request):
    context = {
        "data": [
            {comparison: bahamas, value: n_a_the_bahamas_does_not_levy_corporation_tax, color: table_danger},
            {comparison: barbados, value: "Yes", color: table_success},
...
def taxability_of_disposal_of_shares_by_foreign_shareholder(request):
    context = {
        "data": [
            {comparison: bahamas, value: "No", color: table_success},
...
def taxation_of_partnership_profits(request):
    context = {
        "data": [
...
def taxation_of_branch_profits(request):
    context = {
        "data": [
...
def branch_remittance_tax(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0%", color: table_success},
...
def average_lowest_temperature(request):
    context = {
        "data": [
...
def average_annual_precipitation(request):
    context = {
        "data": [
...
def registry_of_commerce(request):
    context = {
        "data": [
...
def highest_personal_income_tax(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0", color: table_success},
...
def taxation_on_foreign_income(request):
    context = {
        "data": [
            {comparison: bahamas, value: "0", color: table_success},
...
def free_mobile_operator(request):
    context = {
        "data": [
...
def become_permanent_resident(request):
    context = {
        "data": [
...
def social_security_rate_for_corporations(request):
    context = {
        "data": [
...
def social_security_rate_for_employees(request):
    context = {
        "data": [
...
def post_office_box_for_private_person(request):
    context = {
        "data": [
...
def tax_information_exchange_agreements(request):
    context = {
        "data": [
...
def company_liability_of_shareholder(request):
    context = {
        "data": [
...
def company_minimum_number_of_shareholder(request):
    context = {
        "data": [
...
def company_maximum_number_of_shareholder(request):
    context = {
        "data": [
...
def company_restriction_on_nationality_residency_of_shareholder(request):
    context = {
        "data": [
...
def company_corporate_shareholders_allowe(request):
    context = {
        "data": [
...
def company_minimum_number_of_director(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "1.0", color: table_active},
            {comparison: andorra_private_limited_company, value: "1.0", color: table_active},
...
def company_restriction_on_nationality_residency_of_director(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "None", color: table_active},
            {comparison: andorra_private_limited_company, value: "None", color: table_active},
...
def company_local_director_requiremen(request):
    context = {
        "data": [
...
def company_corporate_directors_allowe(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_shareholders__meeting_requiremen(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "No", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_shareholders__meetings_locatio(request):
    context = {
        "data": [
...
def company_minimum_capital_requiremen(request):
    context = {
        "data": [
...
def company_can_the_capital_be_denominated_in_foreign_currenc(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "No", color: table_active},
...
def company_non_par_value_shares_allowe(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "No", color: table_active},
...
def company_bearer_shares_allowe(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "No", color: table_active},
            {comparison: andorra_private_limited_company, value: "No", color: table_active},
...
def company_capital_duty_on_issurance_of_share(request):
    context = {
        "data": [
...
def company_registered_office_needs_to_be_in_the_countr(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_company_secretary_registered_agent_requiremen(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "No", color: table_active},
...
def company_restrictions_to_foreign_investor(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "None", color: table_active},
            {comparison: andorra_private_limited_company, value: "None", color: table_active},
...
def company_time_needed_for_registratio(request):
    context = {
        "data": [
...
def company_shelf_companies_availabl(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_publicly_accessible_records_of_director(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "No", color: table_active},
...
def company_publicly_accessible_records_of_shareholder(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "No", color: table_active},
            {comparison: andorra_private_limited_company, value: "No", color: table_active},
...
def company_publicly_accessible_financial_statements(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "No", color: table_active},
            {comparison: andorra_private_limited_company, value: "No", color: table_active},
...
def company_beneficial_ownership_disclosure(request):
    context = {
        "data": [
...
def company_nominee_shareholder_allowed(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "No", color: table_active},
...
def company_annual_return_requirement(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "No", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_tax_return_requirement(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "No", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_requirement_to_maintain_accounting_records(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_foreign_currency_accounting_allowed(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "No", color: table_active},
...
def company_accounting_records_can_be_held_outside_the_country(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "No", color: table_active},
...
def company_financial_statements_requirement(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_financial_statements_filing_requirement(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "No", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_accounting_principles_for_financial_statement(request):
    context = {
        "data": [
...
def company_consolidated_financial_statements_requirement(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_exemption_to_consolidated_financial_statements_requirement(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "Yes", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_audit_requirement(request):
    context = {
        "data": [
            {comparison: bahamas_ibc, value: "No", color: table_active},
            {comparison: andorra_private_limited_company, value: "Yes", color: table_active},
...
def company_exemptions_to_audit_requirement(request):
    context = {
        "data": [
...
def trust_registration_requiremen(request):
    context = {
        "data": [
...
def trust_settlor_residency_requiremen(request):
    context = {
        "data": [
...
def trust_beneficiary_residency_requiremen(request):
    context = {
        "data": [
            {comparison: bahamas_non_resident_trust,
             value: "Yes, should not be a permanent resident of the Bahamas", color: table_active},
...
def trust_trustee_residency_requiremen(request):
    context = {
        "data": [
...
def trust_should_the_trustee_be_license(request):
    context = {
        "data": [
            {comparison: bahamas_non_resident_trust, value: "Yes", color: table_active},
...
def trust_protector_allowe(request):
    context = {
        "data": [
            {comparison: bahamas_non_resident_trust, value: "Yes", color: table_active},
            {comparison: barbados_international_trust, value: "Yes", color: table_active},
...
def trust_protector_requiremen(request):
    context = {
        "data": [
...
def trust_perpetuity_perio(request):
    context = {
        "data": [
...
def trust_restriction_on_trust_propert(request):
    context = {
        "data": [
            {comparison: bahamas_non_resident_trust,
...
def trust_confidentialit(request):
    context = {
        "data": [
...
def trust_asset_protectio(request):
    context = {
        "data": [
            {comparison: bahamas_non_resident_trust, value: "Yes", color: table_active},
            {comparison: barbados_international_trust, value: "Yes", color: table_active},
...
def trust_reporting_requiremen(request):
    context = {
        "data": [
            {comparison: bahamas_non_resident_trust, value: "No", color: table_active},
            {comparison: barbados_international_trust, value: "No", color: table_active},
