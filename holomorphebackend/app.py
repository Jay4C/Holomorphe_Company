...
# Get information about electricity generation without license in Africa
# k1 = country
# k2 = Amount of the fine for electricity generation without license and not connected to the national grid for
# internal needs ?
# k3 = Number of years of imprisonment for electricity generation without license and not linked to any grid or
...
# k5 = Possible control of the power plant by any jurisdictions without that the producer holds a license ?
# k6 = Flixbus in the capital ?
@app.route("/international_electricity_generation_without_license_in_africa")
def international_electricity_generation_without_license_in_africa():
    data = [
...
# Get information about electricity generation without license in Oceania
# k1 = country
# k2 = Amount of the fine for electricity generation without license and not connected to the national grid for
# internal needs ?
# k3 = Number of years of imprisonment for electricity generation without license and not linked to any grid or
...
# k5 = Possible control of the power plant by any jurisdictions without that the producer holds a license ?
# k6 = Flixbus in the capital ?
@app.route("/international_electricity_generation_without_license_in_oceania")
def international_electricity_generation_without_license_in_oceania():
    data = [
...
# Get information about countries with gas networks
# k1 = country
# k2 = Does the country own a natural gas network in his territory ?
@app.route("/countries_with_gas_networks")
def countries_with_gas_networks():
    data = [
            {'k1': 'Albania', 'k2': 'Yes'},
            {'k1': 'Andorra', 'k2': 'No'},
            {'k1': 'Armenia', 'k2': 'Yes'},
...
# Get information about international energy needs for abundance
# k1 = country
# k2 = Energy needs per day in kWh ?
@app.route("/international_energy_needs_for_abundance")
def international_energy_needs_for_abundance():
    data = [
...
# Get information about the forecast of worldwide ammonia production
# k1 = Year
# k2 = Forecast of the production in thousands of tons
# k3 = Forecast of the worldwide average price per ton in USD
@app.route("/forecast_of_worldwide_ammonia_production")
def forecast_of_worldwide_ammonia_production():
    data = [
...
# Get information about the forecast of worldwide natural gas reserves
# k1 = Year
# k2 = Forecast of worldwide natural gas reserves in cubic meters
@app.route("/forecast_of_worldwide_natural_gas_reserves")
def forecast_of_worldwide_natural_gas_reserves():
    data = [
...
# Get information about the international real estate price
# k1 = Country
# k2 = Capital
# k3 = Price for apartment [Euros per square meter]
# k4 = Price for land to build [Euros per square meter]
@app.route("/international_real_estate_price")
def international_real_estate_price():
    data = [
...
# Get information about the international plastic waste
# k1 = Country
# k2 = Quantity [kilogram per capita per day]
# k3 = Quantity [kilogram per year]
@app.route("/international_plastic_waste")
def international_plastic_waste():
    data = [
...
# Get information about the forecast of worldwide coal reserves
# k1 = Year
# k2 = Billions of tons of coal
@app.route("/forecast_of_worldwide_coal_reserves")
def forecast_of_worldwide_coal_reserves():
    data = [
            {'k1': '2019', 'k2': '1069,6'},
            {'k1': '2020', 'k2': '1061,04'},
            {'k1': '2021', 'k2': '1052,55'},
...
# Get information about the forcecast of worldwide crude oil reserves
# k1 = Year
# k2 = Tons of crude oil
@app.route("/forecast_of_worldwide_crude_oil_reserves")
...
# Get information about the forecast of worldwide uranium reserves
# k1 = Year
# k2 = Tons of uranium
@app.route("/forecast_of_worldwide_uranium_reserves")
def forecast_of_worldwide_uranium_reserves():
    data = [
            {'k1': '2009', 'k2': '7813591'},
            {'k1': '2010', 'k2': '7758896'},
            {'k1': '2011', 'k2': '7704584'},
...
# Get information about the worldwide mercury producers
# k1 = Country
# k2 = Free energy devices possible to use ?
# k3 = Ratification of Minamata Convention ?
# k4 = Suitable for the nuclear transmutation of mercury ?
@app.route("/worldwide_mercury_producers")
def worldwide_mercury_producers():
    data = [
...
# Get information about countries who are ratified minamata convention
# k1 = Country
@app.route("/countries_ratified_minamata_convention")
def countries_ratified_minamata_convention():
    data = [
            {'k1': 'Angola'},
            {'k1': 'Argentina'},
            {'k1': 'Armenia'},
